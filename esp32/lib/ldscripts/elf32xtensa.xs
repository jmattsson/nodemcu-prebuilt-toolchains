...
ENTRY(_start)
SEARCH_DIR("=/home/johny/src/nodemcu-prebuilt-toolchains/build/esp108/../../esp32/xtensa-esp108-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
